...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///total_points.db'

#postgresql://point_dashboard_user:dnrSPD67tIl9ldtOJwtvCZNAkOqbZLbE@dpg-ctunhhqj1k6c73d0439g-a.ohio-postgres.render.com/point_dashboard
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['SQLALCHEMY_BINDS'] = {'events': 'sqlite:///events.db', 'users': 'sqlite:///users.db', 'EditHistory': 'sqlite:///history.db'}
...
def show_total_points():
    total_points = TotalPoint.query.all()
...
def add_or_edit_event(event_id=None):
    ...
    members_all = TotalPoint.query.all()
